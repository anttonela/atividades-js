...
//			uma const para nomear os meses e suas informações fixas para aparecer na tela
...
// 			para adicionar informações na tabela de dados por meio do grafico de envios
//			então criou mes, categoria, tipo e valor que são0 as questões cobradas para enviar os dados
	adicionarLancamento () {
...
//			aqui deixa sem nada para não ter nenhuma palavra antesao clicar no botão de digitar
		categoria.value = "";
		valor.value = "";
	}
